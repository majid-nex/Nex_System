...
from NexSystem.plugins.Mongo_DB.gbans import update_gban, delete_gban


class NexClient(TelegramClient):
    """NexClient - Subclass of Telegram Client."""
    ...
    def __init__(self, *args, **kwargs):
        ...
        if BOT_TOKEN:
            self.bot = TelegramClient(
                "NexSystem", api_id=API_ID_KEY, api_hash=API_HASH_KEY
