...
from NexSystem.strings import on_string
import logging
import importlib
import asyncio
import time
...
from NexSystem.plugins import to_load
...
for load in to_load:
    try:
        imported = importlib.import_module("NexSystem.plugins." + load)
...
@System.on(system_cmd(pattern="nex stats"))
